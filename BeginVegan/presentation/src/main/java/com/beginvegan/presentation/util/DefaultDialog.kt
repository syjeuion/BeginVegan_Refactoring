...
import com.beginvegan.presentation.databinding.DialogDefaultBinding

class DefaultDialog private constructor(
    ...
    class Builder {
        ...
        fun show(fragmentManager: FragmentManager, tag: String?): DefaultDialog {
