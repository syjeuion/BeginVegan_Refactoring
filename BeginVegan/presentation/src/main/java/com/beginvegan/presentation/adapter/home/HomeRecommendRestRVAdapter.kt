...
//) :
//    RecyclerView.Adapter<com.example.presentation.adapter.home.HomeRecommendRestRVAdapter.DataViewHolder>() {
//    private var listener: _root_ide_package_.com.example.presentation.adapter.home.HomeRecommendRestRVAdapter.OnItemClickListener? = null
...
//        parent: ViewGroup,
//        viewType: Int
//    ): _root_ide_package_.com.example.presentation.adapter.home.HomeRecommendRestRVAdapter.DataViewHolder {
...
//    }
//
//    override fun onBindViewHolder(holder: _root_ide_package_.com.example.presentation.adapter.home.HomeRecommendRestRVAdapter.DataViewHolder, position: Int) {
...
//    }
//
//    fun setOnItemClickListener(listener: _root_ide_package_.com.example.presentation.adapter.home.HomeRecommendRestRVAdapter.OnItemClickListener) {
